...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-white to-green-100">
      {/* Background Pattern */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            ...
            <p className="mt-6 text-xl text-gray-600 leading-relaxed">
              Компания "Строй+" - ваш надежный партнер в области современного строительства. 
              Мы создаем качественные и инновационные решения для современного мира.
            </p>
          ...
          <div className="relative animate-slide-in">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-xl">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <div className="font-semibold text-gray-900">Качественно</div>
                  <div className="text-sm text-gray-600">100% надежные материалы</div>
                </div>
              </div>
            </div>
          </div>
